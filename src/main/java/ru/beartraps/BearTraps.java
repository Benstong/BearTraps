...
public class BearTraps extends JavaPlugin implements Listener, CommandExecutor {
    ...
    private NamespacedKey trapCamouflageKey;
    ...
    public void onEnable() {
        ...
        trapCamouflageKey = new NamespacedKey(this, "trap_has_camo");
    ...
    private void startDetectionTask() {
        new BukkitRunnable() {
            ...
            public void run() {
                baitTimer++;
                boolean runBaitLogic = (baitTimer % 10 == 0);
